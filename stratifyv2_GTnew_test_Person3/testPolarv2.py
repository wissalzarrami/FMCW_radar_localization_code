...
model = HeatmapPredictionModel(num_heads=4, hidden_size=2048)
model.load_state_dict(torch.load('/store/wizar/HAR_code_complex/radardataM/radar_detection1/wRadar/Polar/stratifyv2_GTnew_test_person1/modelpolar_stratifyv2_trVal_Pers2_3_test_REST.pth'))
model.to(device)
model.eval()
...
test_paths_file = '/store/wizar/HAR_code_complex/radardataM/radar_detection1/wRadar/Polar/stratifyv2_GTnew_test_person1/test_paths.txt'
...
output_csv_path = '/store/wizar/HAR_code_complex/radardataM/radar_detection1/wRadar/Polar/stratifyv2_GTnew_test_person1/predictions_summary_noperson1.csv'
