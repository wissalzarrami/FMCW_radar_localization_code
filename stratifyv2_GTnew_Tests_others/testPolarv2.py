...
model.load_state_dict(torch.load('/store/wizar/HAR_code_complex/radardataM/radar_detection1/wRadar/Polar/stratifyv2_GTnew_COPY/modelpolar_stratifyv2_GTnew1_EXPlab.pth'))
model.to(device)
model.eval()
...
test_paths_file = '/store/wizar/HAR_code_complex/radardataM/radar_detection1/wRadar/Polar/stratifyv2_GTnew_COPY/test_paths_EXPlab.txt'
...
output_csv_path = '/store/wizar/HAR_code_complex/radardataM/radar_detection1/wRadar/Polar/stratifyv2_GTnew_COPY/predictions_testforlab2_summary.csv'
